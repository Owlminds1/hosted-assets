...
const LayoutCharacterEmotionsAndResponses4
 = () => {
  ...
  return (
   <div className='p-5 flex justify-center items-center min-h-screen bg-[#F8FCFA]'>
     ...
     <Image src="/carector-response/boy.jpg" width={600} height={600} alt='girl image'/>
     <Inputs/>
    </div>
   </div>
  )
...
export default LayoutCharacterEmotionsAndResponses4
