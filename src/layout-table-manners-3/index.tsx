...
import SlideData from "@/layout-table-manners-3/slidData.json";
import { Navigation } from "swiper/modules";
import "swiper/css/navigation";

const LayoutTableManners3 = () => {
            ...
            <SwiperSlide key={index}>
              <div className="relative w-full flex justify-center items-center  ">
                <Image
                  ...
                  alt="slider image"
                />
                <h1 className="absolute bg-[#000000a7] text-xl text-white w-[350px] p-4 text-center z-10 rounded-lg  bottom-8">
                  {item.text}
                </h1>
              </div>
            </SwiperSlide>
...
export default LayoutTableManners3;
