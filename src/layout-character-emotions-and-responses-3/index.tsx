...
const LayoutCharacterEmotionsAndResponses3 = () => {
  ...
  return (
   <div className='p-5 flex justify-center items-center min-h-screen bg-[#F8FCFA]'>
     ...
     <Image src="/carector-response/girl_image.jpg" width={600} height={600} alt='girl image'/>
     <Inputs/>
    </div>
   </div>
  )
...
export default LayoutCharacterEmotionsAndResponses3
