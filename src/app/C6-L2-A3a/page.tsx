    ...
    <div className=" bg-white text-black p-5 min-h-screen flex justify-center">
      <div className="w-full md:w-[900px] flex flex-col py-8 gap-5 p-3 border ">
        ...
        <div>
          ...
          <Pera paraContent={
            "Max explained, “Being responsible means taking care of our tasks and our things, and making good choices that help us and others. Responsibility turns small actions into big results.”"
          } />
        </div>
        <div>
