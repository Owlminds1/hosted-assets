"use client";
import data from "@/layout-Moring-Routine-Sorting/data.json";
import { useEffect, useState } from "react";
import Confetti from "react-confetti";

export default function LayoutMorningRoutineSorting() {
...
const [message, setMessage] = useState<string>("");
 ...
 const correctOrder = data.map((item) => item.id); // static original correct order
  ...
  useEffect(() => {
    function shuffleTasks(array: typeof data) {
  ...
  return (
    <div className=" py-8 min-h-screen bg-[#F8FCFA] flex items-center justify-center gap-3 pt-5 flex-col">
     <h1 className="text-4xl text-center mb-8">Sort in Morning Routine Sorting</h1>
